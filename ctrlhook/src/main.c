...
void *MainCtrlControlSetHandler(int (*func)(SceCtrlData *pad));
...
// function
void CtrlControlClearCaches(void)
{
...
void *MainCtrlControlSetHandler(CTRL_HANDLER func)
{
...
void *BackupCtrlControlSetHandler(CTRL_HANDLER func)
{
...
void *CtrlControlSetHandler(CTRL_HANDLER func)
{
	if(result == 1)
	{
		return MainCtrlControlSetHandler(func);
	}
	else
	{
		return BackupCtrlControlSetHandler(func);
	}
}
